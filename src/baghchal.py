...
class Baghchal:
    ...
    define the board setup, pieces, valid moves and other other rules
    """
    ...
    def movetiger(self, tiger, r2, c2):
        ...
        if self.validjump(r1, c1, r2, c2):
            ...
            self.board[r1,c1] = 0
            self.tigers[tiger] = [r2,c2]
            self.lastgoatrow = int((r1+r2)/2)
            self.lastgoatcol = int((c1+c2)/2)
            self.board[self.lastgoatrow, self.lastgoatcol] = 0
